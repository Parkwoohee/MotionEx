...
public class Terminal : MonoBehaviour
{
    ...
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("7"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
    public void OffSendData()
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("0"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
    public void SendData1()
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("2"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
    public void OffSendData1()
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("3"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
    public void SendData2()
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("4"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
    public void OffSendData2()
    {
        Marshal.PtrToStringAnsi(BTM_SendDataFast("5"));
        //Marshal.PtrToStringAnsi(BTM_SendDataFast(txtInput.text));
    }
